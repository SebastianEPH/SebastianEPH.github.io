    ...
    return(
        <Container>
                ...
                <Col xl={8}>
                    <Row>
                        ...
                        {version?
                            ...
                            : name && !version? <></> :<ItemProjectLoader/>
                        }
                        {architecture?
                            <ItemProject data={{
                                title:"Arquitectura",
                            ...
                            : name && !architecture? <></> :<ItemProjectLoader/>
                        }
                        {state?
                            <ItemProject data={{
                                title:"Estado",
                        ...
                        {platform?
                            ...
                            : name && !platform? <></> :<ItemProjectLoader/>
                        }
                        {licence?
                            <ItemProject data={{
                                title:"Licencia",
                            ...
                            : name && !licence?  <></> :<ItemProjectLoader/>
                        }
                        {ide?
                            <ItemProject data={{
            ...
            {web_deploy ?
                    ...
                    {web_deploy?
                        <button className={"button-info "} onClick={()=>{window.location.href = web_deploy}}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="ms-2 bi bi-box-arrow-up-right" viewBox="0 0 22 22">
                                ...
                                <path fillRule="event" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/>
                            </svg>
                        </button>
                        :
                        <TitleLoader/>
                ...
                :
                name && !web_deploy ?  false :<TitleLoader/>
            }
                ...
                <Col md={6} >
                    <Row className={"p-2 pb-0"}>
                        {repository?
                            ...
                            :
                            name && !repository ?  false :<TitleLoader/>
                        }
                    </Row>
                </Col>
                <Col md={6}>
                    <Row className={"p-2 pb-0"}>
                        {documentation?
                            ...
                            :
                            name && !documentation ?  false :<TitleLoader/>
                        }
                    </Row>
                </Col>
            </Row>
            ...
            <div className={"mb-5 pt-4"}>
                <Link to={"/"}  className={"btn btn-flotante  btn-danger" }>
                    Volver
                </Link>
            </div>
