...
export const ItemScreenshot =({screenshots:st,typeName,reloadForDB, onlyRead=true}) =>{
    ...
    return(
        ...
        {st.length >= 1?
            <ul>
                {st.map((data, index)=>{
                    return(
                        <li key={"screenshot"+index} id={"border-item"}  className={" list-group-item"}>
                            {!onlyRead&&(
                            ...
                            <div className={"text-center"}>
                                ...
                                <img id={"screenshot-item"} className={"mt-4 mb-4"} key={index+("-img")}  src={data.screenshot} alt={typeName}/>
                            </div>
                        </li>
                    )})
                }
